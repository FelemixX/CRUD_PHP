...
<form action="update.php" method="post">
    ...
    <div class="mb-3">
        ...
        <select name="product_name" class="form-select" aria-label="product select" id="product_name">
            <!-- Выпадашка -->
        ...
        <select name="document_number" class="form-select" aria-label="document select" id="document_number">
            <!-- Выпадашка -->
        ...
        <select name="doc_creation_date" class="form-select" aria-label="document creation date select"
                id="creation_date">  <!-- Выпадашка -->
